...
let menuItems = [
    { text: "Beranda", href: "homepage" },
    {
        text: "Profil",
        href: "#",
        submenu: [
            { text: "Lihat Profil", href: "profil_singkat" },
            { text: "Struktur Organisasi", href: "profil/struktur_organisasi" },
            { text: "Visi & Misi", href: "profil/visi_misi" },
            { text: "Galeri", href: "profil/galeri" }
        ]
    },
    { text: "Jurusan", href: "jurusan" },
...
function createVideoCard(videoUrl, title, description) {
    const card = document.createElement("div");
    card.className = "card h-100 video-card overflow-hidden";
